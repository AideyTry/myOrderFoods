<template>
	<div class="header">
		...
		<div class="bulletin-wrapper" v-if="seller" @click="detailShow()">
		...
		<transition name="fade">
			<div v-show="details" class="detail" v-if="seller">
...
<style lang="scss" scoped>
	...
	.header{
		...
		.detail{
			...
			// }
			.detail-wrapper{
				min-height:100%;//最小高度要有视口高。
				width:100%;
				.detail-main{
					//向上要margin,向下要有paddding
					margin-top:64px;
					padding-bottom:64px;//起到决定性作用
					.name{
						line-height:16px;
						text-align:center;
						font-size:16px;
